...
async def search_users(params: UserSearchInput) -> str:
    ...
    Args:
        params (UserSearchInput): Validated input parameters containing:
            ...
            - response_format (ResponseFormat): Output format, either 'markdown' or 'json' (default: 'markdown')

    Returns:
        str: Formatted search results. For JSON format, returns structured data with schema:
            {
...
# Constants
API_BASE_URL = os.environ.get("EXAMPLE_API_URL", "https://api.example.com")
